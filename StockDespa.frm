...
Begin VB.Form StockDespa 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Ingreso de Despachos"
   ClientHeight    =   6165
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   6765
   ...
   Begin VSFlex8Ctl.VSFlexGrid FG1 
      ...
      FormatString    =   $"StockDespa.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Label Label2 
      Alignment       =   2  'Center
      Caption         =   "Stock de Mercadería de Importación"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   15.75
         Charset         =   0
