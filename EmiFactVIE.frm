...
Object = "{7F08C7CD-FD93-4CEC-916C-018CC3EE6845}#1.0#0"; "abcitf.ocx"
Begin VB.Form EmiFact 
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00F9FADC&
      Caption         =   " Porcentaje de I.B. Prov. Bs.As.  "
      Enabled         =   0   'False
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   9
   ...
   Begin ABCITFLib.Abcitf BarCod 
      ...
      Caption         =   "1234567890123456789012345678901234657890"
      CharSpacing     =   100
      Extra1          =   -1
      Extra2          =   -1
      ...
      Xunit           =   7
      String2         =   "1234567890123456789012345678901234657890"
      PictureWidth    =   58,4
      PictureHeight   =   7
   End
...
Dim ValIB As Currency, TotIB As String
    ...
    If Check1.Value = 1 Then
        ...
        If LaLetra = "A" Then
            Select Case TipoFac
                ...
                Case 2:   CodFactAFIP = 2
                Case 3:   CodFactAFIP = 3
            End Select
        Else
            Select Case TipoFac
                Case 1:   CodFactAFIP = 6
                Case 2:   CodFactAFIP = 7
                Case 3:   CodFactAFIP = 8
            End Select
        End If
...
If TipoFac = 4 Then
    DibujaRect 260, 7, 268, 27, 30, 30
    DibujaRect 260, 28, 268, 49, 30, 30
    DibujaRect 260, 50, 268, 74, 30, 30
    DibujaRect 260, 75, 268, 119, 30, 30
    DibujaRect 260, 120, 268, 165, 30, 30
    ...
    Escribe "Arial", 10, 0, 0, 255, 31, "Descuento"
    Escribe "Arial", 10, 1, 1, 255, 55, "Subtotal"
    Escribe "Arial", 10, 0, 0, 255, 87, "IVA Insc."
    Escribe "Arial", 10, 0, 0, 255, 135, "IVA No Insc."
...
IMPRE.VP1.TableCell(tcFontBold, 1, 6) = True
 ...
 IMPRE.VP1.EndTable
    ...
    If ValIB > 0 Then
            Escribe "Arial", 10, 0, 0, 250.5, 135, "Perc.IB BsAs"
    End If
...
Escribe "ARIAL", 7, 1, 0, 42, 30, "email: alestel@speedy.com.ar"
...
Escribe "Lucida Console", 8, 0, 0, 34, 140, "    IB Conv.Mult.: 901-039041-2"
...
'Primer Rectángulo
        ...
        Escribe "", 14, 1, 0, 17, 140, "0003-" & Format(NROFAC, "00000000")
...
Impte = TotBruto + TotSIVA
    ...
    Escribe "Arial", 10, 0, 0, 255, 11, "Subtotal"
    Escribe "Arial", 10, 0, 0, 255, 31, "Descuento"
    Escribe "Arial", 10, 1, 0, 255, 55, "Subtotal"
    Escribe "Arial", 10, 0, 0, 255, 87, "IVA Insc. 21%"
    Escribe "Arial", 10, 0, 0, 255, 135, "IVA No Insc."
...
RESTO = DetFact.FG1.TextMatrix(I1, 1)
Impte = DetFact.FG1.TextMatrix(I1, 8)
' Obtiene los Descuentos del Cliente para esa seccion/rubro
...
If Val(DetFact.FG1.TextMatrix(I1, 6)) > 0 Then
    ...
    Else
        RgSTOK!Stock = RgSTOK!Stock + DetFact.FG1.TextMatrix(I1, 6)
        RgSTOK!ENTRADAS = RgSTOK!ENTRADAS - DetFact.FG1.TextMatrix(I1, 6)
    End If
End If
...
If Val(DetFact.FG1.TextMatrix(I1, 2)) > 0 Then
    ...
    Else
        RgSTOK!Stock = RgSTOK!Stock + DetFact.FG1.TextMatrix(I1, 2)
        RgSTOK!ENTRADAS = RgSTOK!ENTRADAS - DetFact.FG1.TextMatrix(I1, 2)
    End If
End If
...
WB1.Document.parentWindow.scrollTo 0, 9999999
    ...
    Tipo_Cbte = CodFactAFIP: Punto_Vta = 3
