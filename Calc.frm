...
Private Sub Form_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 44 Or KeyAscii = 46 Then
            KeyAscii = 44
    ElseIf Not (KeyAscii > 47 Or KeyAscii < 58) And KeyAscii > 31 Then
                Exit Sub
    End If
    ...
    End If
    If DecimalFlag Then
        Readout = Readout + Chr$(KeyAscii)
    Else
        Readout = left(Readout, InStr(Readout, Format(0, ".")) - 1) + Chr$(KeyAscii) + Format(0, ".")
    End If
...
Me.Move 4100, 3000, 3360, 3345
       

' Calculator.Width = 3360
' Calculator.Height = 3345
...
FCMENU.Toolbar1.Buttons(3).Value = tbrUnpressed
Unload Me
